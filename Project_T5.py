# -*- coding: utf-8 -*-
"""ProjectT5streamlit.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1JCXzPKSDhrMOADWjnAJ0qBP2DN228hSF
"""
...
print("List of files in the extracted folder:")
...
if tunnels:
    # Use the first tunnel (HTTP) from the list
    public_url = tunnels[0].public_url

    # Print the URL and access the app in the browser
    print("Public URL:", public_url)
else:
    print("No tunnels are currently active.")
